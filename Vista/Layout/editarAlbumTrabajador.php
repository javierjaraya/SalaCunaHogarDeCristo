                                            ...
                                            <form id="fm-album" method="post" class="form-horizontal well" enctype="multipart/form-data">
                                                <fieldset>
                                                    ...
                                                    <div class="form-actions">
                                                        <button type="button" onclick="guardarAlbum()" class="btn btn-primary">Guardar Cambios</button>
                                                        <button type="button" onClick="location.href = 'verAlbumTrabajador.php?id=<?php echo $idAlbum; ?>'" class="btn">Cancelar</button>
                                                    </div>
                                                </fieldset>
                                                            ...
                                                            function guardarAlbum() {
                                                                ...
                                                                $('#fm-album').form('submit', {
                                                                    ...
                                                                    success: function (result) {
                                                                        ...
                                                                        if (result.success) {
                                                                            window.location = "verAlbumTrabajador.php?id="+idAlbum;
                                                                        } else {
